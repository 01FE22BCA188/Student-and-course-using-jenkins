...
public class Student{
    public static void main(String[] args) {
        Courses student01 = new Courses("Sumeet", "Computer Application", "BCA");
        ...
        Courses student02 = new Courses("Anirudh","B.Sc", "B.sc.CS");
        ...
        // Display courses and marks less than 40 for Sumeet
        System.out.println("Courses and Marks Less Than 40 for Sumeet if any : ");
        for (Map.Entry<String, Integer> entry : kapilCoursesMarksLessThan40.entrySet()) {
                System.out.println(entry.getKey() + " - " + entry.getValue());    
        }
        System.out.println("End");
        
        // Display courses and marks less than 40 for Anirudh
        System.out.println("\nCourses and Marks Less Than 40 for Anirudh if any : ");
